     ...
     function drawTreeMap(id, root, extent,name, type, tooltip) {
      ...
      //   }
       ...
       var rects = g.selectAll("rect")
         ...
         .attr("id", function(d) { console.log(d.value);return d.data.Title.replace(/[\W_]+/g," ") +", Gross: "+format(d.value); })
         .attr("class", "node")
         .style("stroke", 'red')
         ...
         .on("mouseover", function(d) {
                         ...
                         tooltip
                           ...
                           .style("font-size", "150%")
                           .html((d.data.Title.replace(/[\W_]+/g," ")) + "<br>" +  " Gross: " +format(d.value));
         ...
         .data(root.descendants())
          ...
          .text(function(d){if(type=="ac"){return "Actor:"}else{return "Director:"} })
        ...
        var back= svg.append('rect')
         ...
         back.on('click', function(d){
          ...
          if(type=="ac"){
          ...
          else{location.href='zoomD1.html'};
           ...
           svg.append('text')
            ...
            svg.append('text')
             ...
             .text(function(d){if(type=="ac"){return "Actors"}else{return "Directors"} })
